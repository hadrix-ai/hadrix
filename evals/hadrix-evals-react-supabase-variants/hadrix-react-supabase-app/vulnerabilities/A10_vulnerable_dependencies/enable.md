...
Note: Unlike code-level cases, dependency advisories are always present in the lock file when the packages are installed. The toggles control whether these findings are expected in evals.
