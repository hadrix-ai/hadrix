...
export function buildUnderstandingAndFamilyMappingSystemPrompt(): string {
  return [
    ...
    "- Role/permission checks are NOT MFA; step-up requires explicit OTP/WebAuthn/reauth or amr/acr/mfa claim checks.",
    ...
    "- Admin/privileged endpoint (path contains /admin or symbols named admin*) performing sensitive actions (including admin data reads) with only basic session/JWT auth and no step-up evidence: suggest missing_admin_mfa.",
